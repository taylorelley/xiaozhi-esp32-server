...
async def handle_mcp_message(
    ...
    if not isinstance(payload, dict):
        logger.bind(tag=TAG).error("MCP message is missing the payload field or has invalid format")
        return
    ...
    if "result" in payload:
        ...
        if msg_id == 1:  # mcpInitializeID
            ...
            if isinstance(result, dict) and "tools" in result:
                ...
                # Replace tool names within all tool descriptions
                ...
                if next_cursor:
                    ...
                    # Refresh the tool cache to ensure MCP tools are included in the function list
