...
class TTSProvider(TTSProviderBase):
    ...
    def _get_auth_headers(self, request_body):
        ...
        # Use UTC time to compute the date
        ...
        # Use TC3-HMAC-SHA256 signing method
        ...
        # Headers must include host and content-type, sorted in dictionary order
        canonical_headers = (
    ...
    async def text_to_speak(self, text, output_file):
        ...
        try:
            # Get request headers (regenerate on every request to keep timestamp and signature current)
