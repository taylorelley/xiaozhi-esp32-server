...
def create_instance(class_name: str, *args, **kwargs) -> VADProviderBase:
    """Factory method that creates a VAD instance."""
    ...
    raise ValueError(f"Unsupported VAD type: {class_name}. Please verify the 'type' field in the configuration is correct")
