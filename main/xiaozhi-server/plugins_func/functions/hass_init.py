...
def append_devices_to_prompt(conn):
    if conn.intent_type == "function_call":
        ...
        # Safely read the plugin configuration
        ...
        if "hass_get_state" in funcs or "hass_set_state" in funcs:
            prompt = "\nBelow is the list of smart devices in my home (location, device name, entity_id), which can be controlled via Home Assistant:\n"
