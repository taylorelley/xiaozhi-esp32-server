...
export default {
 ...
 // UsesetTimeoutEnsureDOMalreadyDone
        setTimeout(() => {
...
.custom-pagination {
  ...
  /* NavigationButtonStyle (First、Previous、Next) */
